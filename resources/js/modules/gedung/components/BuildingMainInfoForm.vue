<template>
  <div class="mb-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div class="lg:col-span-1">
        ...
        <div
          ...
          :class="[
            ...
            form.building_image ? 'border-solid shadow-sm' : 'cursor-pointer',
          ]"
          @click="!form.building_image && triggerSelectFile()"
        >
          <input
            type="file"
            ref="fileInput"
            ...
            @change="onFileChange"
          />
          <template v-if="form.building_image">
            ...
            >
              <button
                type="button"
                @click.stop="$emit('preview-image', imagePreview)"
          ...
          <template v-else>
            ...
            >
              ...
              />
              <p
                class="text-xs font-bold uppercase tracking-wider text-center px-4"
              >
                Klik Unggah Foto
              </p>
            </div>
      ...
      <div
        class="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 items-start"
      >
        <app-input
          label="Kode Gedung"
          v-model="form.building_code"
          placeholder="GD-001"
          :error="!!errors.building_code"
          @clear-error="errors.building_code = null"
          required
        >
        ...
        <app-input
          ...
          @clear-error="errors.building_name = null"
          required
        >
        ...
        <app-input
          label="Lokasi Gedung"
          v-model="form.building_location"
          placeholder="Alamat Gedung"
          class="md:col-span-2"
          :error="!!errors.building_location"
          @clear-error="errors.building_location = null"
          required
        >
